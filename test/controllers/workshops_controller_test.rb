...
class WorkshopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post workshops_url, params: { workshop: { description: @workshop.description, mentor_id: @workshop.mentor_id, quotas: @workshop.quotas, schedule: @workshop.schedule, title: @workshop.title } }
    end
  ...
  test "should update workshop" do
    patch workshop_url(@workshop), params: { workshop: { description: @workshop.description, mentor_id: @workshop.mentor_id, quotas: @workshop.quotas, schedule: @workshop.schedule, title: @workshop.title } }

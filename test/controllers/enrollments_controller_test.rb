...
class EnrollmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post enrollments_url, params: { enrollment: { student_id: @enrollment.student_id, workshop_id: @enrollment.workshop_id } }
    end
  ...
  test "should update enrollment" do
    patch enrollment_url(@enrollment), params: { enrollment: { student_id: @enrollment.student_id, workshop_id: @enrollment.workshop_id } }

...
class MaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material" do
    assert_difference('Material.count') do
      post materials_url, params: { material: { title: @material.title, workshop_id: @material.workshop_id } }
    end
  ...
  test "should update material" do
    patch material_url(@material), params: { material: { title: @material.title, workshop_id: @material.workshop_id } }

class TopicsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @topic.save
        format.html { redirect_to [@workshop, @topic], notice: 'Topic was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @topic.update(topic_params)
        format.html { redirect_to [@workshop, @topic], notice: 'Topic was successfully updated.' }
  ...
  def destroy
    @topic.destroy
    respond_to do |format|
      format.html { redirect_to workshop_topics_url(@workshop), notice: 'Topic was successfully destroyed.' }
